                          ...
                          <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <p class="val_name">{{ $data_detail->name }}</p>
                                                    <h5 class="text-sm-left">Start Date</h5>
                                                    <p>{{ $data_detail->start_date }}</p>
                                                    <h5 class="text-sm-left">Finish Date</h5>
                                                    <p>{{ $data_detail->finish_date }}</p>
                                                    <h5 class="text-sm-left">Location</h5>
                                                    <p>{{ $data_detail->location }}</p>
                                                    <h5 class="text-sm-left">Academy</h5>
                                                    <p>{{ $data_detail->academy }}</p>
                                                    <h5 class="text-sm-left">Commend</h5>
                                                    <p>{{ $data_detail->commend }}</p>
                                                </div>
                                            </div>  
                                        </div>
