            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Enterprise Certification</h1>
                    </div>
                </div>
            </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="Enterprisecer" method="post" class="form-inline" style="margin-left: 15px;">
                  ...
                  <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        @foreach($data as $dataNits)
                            <tr>
                            <td>{{ $nomor++ }}</td>
                            <td><a href="Enterprisecer/{{ $dataNits->name }}" style="color: black;">{{ $dataNits->name }}</td>
